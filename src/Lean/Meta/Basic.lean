...
-- TODO: MessageData
def registerLevelMVarExprProvenance (lmvarId : LMVarId) (expr : Expr) (ref : Syntax) (msgData? : Option String := none) : MetaM Unit :=
  registerLevelMVarExprProvenance lmvarId { lctx := (← getLCtx), expr, ref, msgData? }
