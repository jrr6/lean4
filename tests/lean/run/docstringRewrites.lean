...
info: Errors: ⏎
   ...
   • "lean-manual://a/": Unknown documentation type `a`. Expected one of the following: `section`, `errorExplanation`  ⏎
---
...
info: Errors: ⏎
   ...
   • "lean-manual://f":
    Unknown documentation type `f`. Expected one of the following: `section`, `errorExplanation`
   • "lean-manual://a/b": Unknown documentation type `a`. Expected one of the following: `section`, `errorExplanation`  ⏎
---
info: Result: "foo [](lean-manual://) [](lean-manual://f) lean-manual://a/b "
-/
#guard_msgs in
